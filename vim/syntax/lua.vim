...
syn match luaOperator display '\.'
hi default luaSpecial cterm=bold ctermfg=27
hi default luaDelimiter cterm=bold ctermfg=Brown
...
if version >= 508 || !exists("did_lua_syn_inits")
  ...
  HiLink luaComma            luaDelimiter
  HiLink luaSemiCol          luaDelimiter
  HiLink luaSpecialTable     luaSpecial
